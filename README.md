...
Here I use subtitles in English, German, French, Spanish, and Russian to explore this. The subtitles are from [opensubtitles.org](https://www.opensubtitles.org), provided by [Hermit Dave](https://github.com/hermitdave/FrequencyWords) as ranked lists of words with their word count. Code for this analysis can be found in the [.Rmd file](german.Rmd). This project is an expansion of work by [Tomi Mester](https://hackernoon.com/learning-languages-very-quickly-with-the-help-of-some-very-basic-data-science-cdbf95288333).
