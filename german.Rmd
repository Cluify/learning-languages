...
# remove names etc.
german <- german[! word %in% c("ross","phoebe","rachel","monica","chandler","emma","joey","o","i","k","mike","carol","janice","richard","irossi","charlie","ichandleri","ijoeyi","barry","pete","iphoebei","david","paul","joe","gunther","frank","ralph","e","jack")]
